...
public:
	...
	ASSETSTOOLS_API QWORD MakeValue(AssetsFileReader reader, LPARAM readerPar, QWORD filePos, AssetTypeValueField **ppValueField);
...
class AssetTypeInstance
{
	...
	void **memoryToClear;
public:
	ASSETSTOOLS_API AssetTypeInstance(DWORD baseFieldCount, AssetTypeTemplateField **ppBaseFields, AssetsFileReader reader, LPARAM readerPar, QWORD filePos = 0);
